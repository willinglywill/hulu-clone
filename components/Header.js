...
const Header = () => {
  return (
    <header className='flex flex-col sm:flex-row justify-between items-center py-4 px-8 m-6'>
      ...
      <div className='font-black text-2xl sm:text-3xl md:text-4xl text-center'>
        HULU
      </div>
    </header>
  );
